 ...
 <%  
       ...
       {           
          ...
          response.sendRedirect("http://localhost:8084/sistema_loja2023/funcionario.jsp?status=Consulta efetuada com sucesso&fun_codigo="+  
          ...
          response.sendRedirect("http://localhost:8084/sistema_loja2023/funcionario.jsp?status=Registro nao encontrado");  
       }  
