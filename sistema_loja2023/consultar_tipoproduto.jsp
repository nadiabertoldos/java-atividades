 ...
 <%  
       ...
       {           
          ...
          response.sendRedirect("http://localhost:8084/sistema_loja2023/tipoproduto.jsp?status=Consulta efetuada com sucesso&tpp_codigo="+  
             temp.getString("tpp_codigo")
			 +"&tpp_descricao="+temp.getString("tpp_descricao"));  
       }else{  
          response.sendRedirect("http://localhost:8084/sistema_loja2023/tipoproduto.jsp?status=Registro nao encontrado");  
       }                        
 %>  
 </form>  
 </body>  
