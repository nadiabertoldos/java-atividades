    ...
    public void setNf_valorimposto(String nf_valorimposto) {
      ...
      public void inserirDados(){  
         ...
         try {  
            String query = "insert into tb_notafiscal(nf_codigo,nf_valornf,nf_taxaimpostonf,nf_valorimposto)"
                    + "values("+nf_codigo+",\""+nf_valornf+"\","
                    + "\""+nf_taxaimpostonf+"\",\""+nf_valorimposto+"\")";  
