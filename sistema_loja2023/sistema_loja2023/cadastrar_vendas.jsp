   ...
   <body>
      <form name="form1" method="post" action="vendas.jsp">
         ...
         <table border=1 cellspacing=0 cellpadding=0>
            ...
            <% try { con.setVen_codigo(Integer.parseInt(request.getParameter("ven_codigoField")));
               con.setFun_datavencimento(request.getParameter("fun_codigoField"));
               ...
               con.setVen_observacoes(request.getParameter("ven_observacoesField")); con.inserirDados();
               ...
               response.sendRedirect("http://localhost:8084/sistema_loja2023/vendas.jsp?status=Registro ja existente");
               do{ %>
               <tr>
                  <td width=50>
         ...
         <p><strong>Status:
               <input name="statusField" disabled type="text" id="statusField" size="36"
                  value="<%=request.getParameter(" ven_codigoField")%> foi cadastrado com sucesso">
            </strong></p>
      </form>
   </body>
