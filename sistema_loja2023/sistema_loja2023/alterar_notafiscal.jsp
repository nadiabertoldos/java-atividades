 ...
 <table border=1 cellspacing=0 cellpadding=0 >  
   ...
   <tr>  
      ...
      <td width=50><strong>Taxa de imposto</strong></td>      
      <td width=50><strong>Valor do imposto</strong></td>  
   </tr>  
   ...
   try {  
      ...
      {           
         ...
         <tr>  
            ...
            <td width=50><%out.print(temp.getString("nf_valornf"));%></td>  
            <td width=50><%out.print(temp.getString("nf_taxaimpostonf"));%></td> 
            <td width=50><%out.print(temp.getString("nf_valorimposto"));%></td>
         </tr>   

         <%}  
      }else{  
         response.sendRedirect("http://localhost:8084/sistema_loja2023/notafiscal.jsp?status=Registro nao encontrado");  
      }     
   }catch (Exception e) {  
      e.printStackTrace();  
   }       
