...
public Connection con;  
    ...
    public void setCom_observacoes(String com_observacoes) {
      ...
      public void inserirDados(){  
         ...
         try {  
            String query = "insert into tb_compras(com_codigo,tpg_codigo,for_codigo,nf_codigo,com_datacompra,com_valortotal,com_observacoes) "
                    + "values("+com_codigo+","+tpg_codigo+","+for_codigo+","+nf_codigo+",\""+com_datacompra+"\",\""+com_valortotal+"\",\""+com_observacoes+"\")";  
