   ...
   <body>
      <form name="form1" method="post" action="contapagar.jsp">
         ...
         <table border=1 cellspacing=0 cellpadding=0>
            ...
            <% try { con.setCp_codigo(Integer.parseInt(request.getParameter("cp_codigoField")));
               ...
               con.setCp_observacoes(request.getParameter("cp_observacoesField")); con.inserirDados();
               ...
               response.sendRedirect("http://localhost:8084/sistema_loja2023/contapagar.jsp?status=Registro ja existente"); do{ %>
               <tr>
                  <td width=200>
         ...
         <p><strong>Status:
               <input name="statusField" disabled type="text" id="statusField" size="36"
                  value="<%=request.getParameter(" cp_codigoField")%> foi cadastrado com sucesso">
            </strong></p>
      </form>
   </body>
