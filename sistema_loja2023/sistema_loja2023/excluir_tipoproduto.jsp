   ...
   <body>
      <form name="form1" method="post" action="tipoproduto.jsp">
         ...
         <table border=1 cellspacing=0 cellpadding=0>
            ...
            <% try { con.setTpp_codigo(Integer.parseInt(request.getParameter("tpp_codigoField"))); if
               ...
               <%} } else{ response.sendRedirect("http://localhost:8084/sistema_loja2023/tipoproduto.jsp?status=Registro
         ...
         <p><strong>Status:
               <input name="statusField" disabled type="text" id="statusField" size="36"
                  value="<%=request.getParameter(" tpp_codigoField")%> foi excluido com sucesso">
            </strong></p>
      </form>
   </body>
