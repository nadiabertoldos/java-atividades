 ...
 <%  
       ...
       {           
          ...
          response.sendRedirect("http://localhost:8084/sistema_loja2023/vendas.jsp?status=Consulta efetuada com sucesso&ven_codigo="+  
          ...
          response.sendRedirect("http://localhost:8084/sistema_loja2023/vendas.jsp?status=Registro nao encontrado");  
       }  
