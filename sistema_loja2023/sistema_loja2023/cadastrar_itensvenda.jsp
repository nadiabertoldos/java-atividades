   ...
   <body>
      <form name="form1" method="post" action="itensvenda.jsp">
         ...
         <table border=1 cellspacing=0 cellpadding=0>
            ...
            <% try { con.setItv_codigo(Integer.parseInt(request.getParameter("itv_codigoField")));
               ...
               con.setTpg_codigo(Integer.parseInt(request.getParameter("tpg_codigoField"))); con.setFun_codigo
               (Integer.parseInt(request.getParameter("fun_codigoField")));
               ...
               con.setItv_valortotal(request.getParameter("itv_valortotalField")); con.inserirDados();
               ...
               response.sendRedirect("http://localhost:8084/sistema_loja2023/itensvenda.jsp?status=Registro ja existente"); do{ %>
               <tr>
                  <td width=50>
         ...
         <p><strong>Status:
               <input name="statusField" disabled type="text" id="statusField" size="36"
                  value="<%=request.getParameter(" itv_codigoField")%> foi cadastrado com sucesso">
            </strong></p>
      </form>
   </body>
