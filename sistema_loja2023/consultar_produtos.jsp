 ...
 <%  
       ...
       {           
          ...
          response.sendRedirect("http://localhost:8084/sistema_loja2023/produtos.jsp?status=Consulta efetuada com sucesso&pro_codigo="+  
          ...
          response.sendRedirect("http://localhost:8084/sistema_loja2023/produtos.jsp?status=Registro nao encontrado");  
       }  
