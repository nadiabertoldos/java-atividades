   ...
   <body>
      <form name="form1" method="post" action="compras.jsp">
         ...
         <table border=1 cellspacing=0 cellpadding=0>
            ...
            <tr>
               <td width=200><strong>Codigo</strong></td>
               <td width=200><strong>Codigo tipo pagamento</strong></td>
               <td width=200><strong>Codigo fornecedor</strong></td>
               <td width=200><strong>Nota Fiscal Codigo</strong></td>
               <td width=200><strong>Data da compra</strong></td>
               <td width=200><strong>Valor total</strong></td>
               <td width=200><strong>Observacoes</strong></td>
            </tr>

            <% try { con.setCom_codigo(Integer.parseInt(request.getParameter("com_codigoField")));
               con.setTpg_valorconta(request.getParameter("tpg_codigoField"));
               con.setFor_datavencimento(request.getParameter("for_codigoField"));
               ...
               con.setCom_observacoes(request.getParameter("com_observacoesField")); con.inserirDados();
               ...
               response.sendRedirect("http://localhost:8084/sistema_loja2023/compras.jsp?status=Registro ja existente");
               do{ %>
               <tr>
                  <td width=200>
