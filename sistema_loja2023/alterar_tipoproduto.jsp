      ...
      <form name="form1" method="post" action="tipoproduto.jsp">
         ...
         <table border=1 cellspacing=0 cellpadding=0>
            ...
            <% try { boolean testa=con.alterarDados(); if (con.alterarDados()) { con.setConsulta(); ResultSet
               ...
               <%} }else{ response.sendRedirect("http://localhost:8084/sistema_loja2023/tipoproduto.jsp?status=Registro nao encontrado"); } }catch (Exception e) { e.printStackTrace(); } %>
         </table>
         <p>
         ...
         <p><strong>Status:
               <input name="statusField" disabled type="text" id="statusField" size="36"
                  value="<%=request.getParameter(" tpp_codigoField")%> foi alterado com sucesso">
            </strong></p>
      </form>
   </body>
